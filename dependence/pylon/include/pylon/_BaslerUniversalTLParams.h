...
namespace Basler_UniversalTLParams
{
    ...
    enum FormatEnums
    {
        ...
        Format_BiColorGBGR10,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 10 Bit - Applies to: CoaXPress
        Format_BiColorGBGR12,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 12 Bit - Applies to: CoaXPress
        Format_BiColorGBGR8,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 8 Bit - Applies to: CoaXPress
        Format_BiColorGRGB10,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 10 Bit - Applies to: CoaXPress
        Format_BiColorGRGB12,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 12 Bit - Applies to: CoaXPress
        Format_BiColorGRGB8,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 8 Bit - Applies to: CoaXPress
    ...
    enum PixelFormatEnums
    {
        ...
        PixelFormat_BiColorGBGR10,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 10 Bit - Applies to: CoaXPress
        PixelFormat_BiColorGBGR12,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 12 Bit - Applies to: CoaXPress
        PixelFormat_BiColorGBGR8,  //!< The pixel format is set to Bi-color pixel Green/Blue - Green/Red 8 Bit - Applies to: CoaXPress
        PixelFormat_BiColorGRGB10,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 10 Bit - Applies to: CoaXPress
        PixelFormat_BiColorGRGB12,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 12 Bit - Applies to: CoaXPress
        PixelFormat_BiColorGRGB8,  //!< The pixel format is set to Bi-color pixel Green/Red - Green/Blue 8 Bit - Applies to: CoaXPress
    ...
    */
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalTLParams_Params : public CUniversalTLParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalTLParams_Params_v9_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalTLParams
