...
namespace Basler_UniversalCameraParams
{
    ...
    {
        AcquisitionMode_Continuous,  //!< The acquisition mode is set to Continuous - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        AcquisitionMode_MultiFrame,  //!< The acquisition mode is set to Multi Frame - Applies to: CameraLink, GigE and Stereo ace
        AcquisitionMode_SingleFrame  //!< The acquisition mode is set to Single Frame - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
    };
    ...
    enum AcquisitionStatusSelectorEnums
    {
        ...
        AcquisitionStatusSelector_LineTriggerWait  //!< A check determines whether the camera is currently waiting for a line trigger - Applies to: CameraLink, GigE and racer 2 CXP
    };

    //! Valid values for AcquisitionStopMode
    enum AcquisitionStopModeEnums
    {
        AcquisitionStopMode_Immediate  //!< Acquisition stops immediately even during a frame and only the lines acquired at the time are delivered - Applies to: racer 2 CXP
    };
    ...
    {
        BalanceRatioSelector_Blue,  //!< Balance ratio is applied to the blue channel - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        BalanceRatioSelector_Red  //!< Balance ratio is applied to the red channel - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum BalanceWhiteAutoEnums
    {
        ...
        BalanceWhiteAuto_Off,  //!< The Balance White Auto auto function is disabled - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    {
        BinningHorizontalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: CamEmu, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
    ...
    {
        BlackLevelSelector_All,  //!< The black level value is applied universally - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB, pulse USB and racer 2 CXP
    ...
    {
        BslContrastMode_Linear,  //!< The camera uses a linear function to adjust the contrast - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        BslContrastMode_SCurve  //!< The camera uses an S-curve function to adjust the contrast - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    };
    ...
    {
        BslFrequencyConverterActivation_AnyEdge,  //!< An input pulse is triggered when the source signal falls or rises - Applies to: racer 2 CXP
        BslFrequencyConverterActivation_FallingEdge,  //!< An input pulse is triggered when the source signal falls - Applies to: racer 2 CXP
        BslFrequencyConverterActivation_RisingEdge  //!< An input pulse is triggered when the source signal rises - Applies to: racer 2 CXP
    };

    //! Valid values for BslFrequencyConverterSignalSource
    enum BslFrequencyConverterSignalSourceEnums
    {
        BslFrequencyConverterSignalSource_Counter1Active,  //!< The source signal for the frequency converter is set to Counter 1 Active - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter1End,  //!< The source signal for the frequency converter is set to Counter 1 End - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter1Start,  //!< The source signal for the frequency converter is set to Counter 1 Start - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter2Active,  //!< The source signal for the frequency converter is set to Counter 2 Active - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter2End,  //!< The source signal for the frequency converter is set to Counter 2 End - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter2Start,  //!< The source signal for the frequency converter is set to Counter 2 Start - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter3Active,  //!< The source signal for the frequency converter is set to Counter 3 Active - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter3End,  //!< The source signal for the frequency converter is set to Counter 3 End - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Counter3Start,  //!< The source signal for the frequency converter is set to Counter 3 Start - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_CxpTrigger0,  //!< The source signal for the frequency converter is set to CXP trigger 0 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_CxpTrigger1,  //!< The source signal for the frequency converter is set to CXP trigger 1 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Encoder1,  //!< The source signal for the frequency converter is set to Encoder 1 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_EncoderReverse1,  //!< The source signal for the frequency converter is set to Encoder Reverse 1 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_FrequencyConverter,  //!< The source signal for the frequency converter is set to Frequency Converter - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Line1,  //!< The source signal for the frequency converter is set to Line 1 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Line2,  //!< The source signal for the frequency converter is set to Line 2 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Line3,  //!< The source signal for the frequency converter is set to Line 3 - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Timer1Active,  //!< The source signal for the frequency converter is set to Timer 1 Active - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Timer1End,  //!< The source signal for the frequency converter is set to Timer 1 End - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Timer2Active,  //!< The source signal for the frequency converter is set to Timer 2 Active - Applies to: racer 2 CXP
        BslFrequencyConverterSignalSource_Timer2End  //!< The source signal for the frequency converter is set to Timer 2 End - Applies to: racer 2 CXP
    };
    ...
    {
        BslSensorAcquisitionMode_SingleLine  //!< The sensor acquisition mode is set to Single Line - Applies to: racer 2 CXP
    };
    ...
    {
        BslShadingCorrectionMode_Factory,  //!< Shading correction is based on the values stored in the factory correction set - Applies to: racer 2 CXP
        BslShadingCorrectionMode_Off,  //!< Shading correction is disabled - Applies to: racer 2 CXP
        BslShadingCorrectionMode_User  //!< Shading correction is based on the values stored in the user correction set - Applies to: racer 2 CXP
    };

    //! Valid values for BslShadingCorrectionSelector
    enum BslShadingCorrectionSelectorEnums
    {
        BslShadingCorrectionSelector_DSNU,  //!< Dark Signal Non-Uniformity (DSNU) correction is performed - Applies to: racer 2 CXP
        BslShadingCorrectionSelector_PRNU  //!< Photo Response Non-Uniformity (PRNU) correction is performed - Applies to: racer 2 CXP
    };

    //! Valid values for BslShadingCorrectionSetCreateResult
    enum BslShadingCorrectionSetCreateResultEnums
    {
        BslShadingCorrectionSetCreateResult_Error,  //!< An error occurred while creating the shading correction set - Applies to: racer 2 CXP
        BslShadingCorrectionSetCreateResult_ErrorAbort,  //!< Image acquisition was aborted while creating the shading correction set - Applies to: racer 2 CXP
        BslShadingCorrectionSetCreateResult_ErrorRange,  //!< The shading correction values are outside the allowed range - Applies to: racer 2 CXP
        BslShadingCorrectionSetCreateResult_NoError  //!< The shading correction set was created successfully - Applies to: racer 2 CXP
    };

    //! Valid values for BslShadingCorrectionSetCreateStatus
    enum BslShadingCorrectionSetCreateStatusEnums
    {
        BslShadingCorrectionSetCreateStatus_Active,  //!< A shading correction set is being created - Applies to: racer 2 CXP
        BslShadingCorrectionSetCreateStatus_ErrorReverseX,  //!< A Reverse X error occurred while creating a shading correction set - Applies to: racer 2 CXP
        BslShadingCorrectionSetCreateStatus_Inactive  //!< No shading correction set is being created - Applies to: racer 2 CXP
    };

    //! Valid values for BslShadingCorrectionSetStatus
    enum BslShadingCorrectionSetStatusEnums
    {
        BslShadingCorrectionSetStatus_Empty,  //!< The shading correction set has no entries - Applies to: racer 2 CXP
        BslShadingCorrectionSetStatus_Error,  //!< An error occurred - Applies to: racer 2 CXP
        ...
        BslShadingCorrectionSetStatus_Ok  //!< The shading correction set is valid - Applies to: racer 2 CXP
    };
    ...
    enum ChunkSelectorEnums
    {
        ...
        ChunkSelector_FrameID,  //!< The Frame ID chunk can be enabled - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        ChunkSelector_LineStatusAll,  //!< The Line Status All chunk can be enabled - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        ChunkSelector_Timestamp,  //!< The Timestamp chunk can be enabled - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
    ...
    enum CounterEventSourceEnums
    {
        ...
        CounterEventSource_Counter3Active,  //!< The selected counter counts the number of Counter 3 Active signals - Applies to: racer 2 CXP
        CounterEventSource_Counter3End,  //!< The selected counter counts the number of Counter 3 End signals - Applies to: ace USB and racer 2 CXP
        CounterEventSource_Counter3Start,  //!< The selected counter counts the number of Counter 3 Start signals - Applies to: racer 2 CXP
        ...
        CounterEventSource_Encoder1,  //!< The selected counter counts the number of Encoder 1 signals - Applies to: racer 2 CXP
        CounterEventSource_EncoderReverse1,  //!< The selected counter counts the number of Encoder Reverse 1 signals - Applies to: racer 2 CXP
        ...
        CounterEventSource_FrequencyConverter,  //!< The selected counter counts the number of Frequency Converter signals - Applies to: racer 2 CXP
        ...
        CounterEventSource_LineTriggerWait,  //!< The selected counter counts the number of Line Trigger Wait signals - Applies to: racer 2 CXP
    ...
    {
        CounterResetActivation_AnyEdge,  //!< The counter is reset on any edge of the signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        CounterResetActivation_FallingEdge,  //!< The counter is reset on the falling edge of the signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    ...
    enum CounterResetSourceEnums
    {
        ...
        CounterResetSource_Counter1End,  //!< The selected counter can be reset by a Counter 1 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        CounterResetSource_Counter2End,  //!< The selected counter can be reset by a Counter 2 End signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        CounterResetSource_Counter3Active,  //!< The selected counter can be reset by a Counter 3 Active signal - Applies to: racer 2 CXP
        CounterResetSource_Counter3End,  //!< The selected counter can be reset by a Counter 3 End signal - Applies to: ace USB and racer 2 CXP
        CounterResetSource_Counter3Start,  //!< The selected counter can be reset by a Counter 3 Start signal - Applies to: racer 2 CXP
        CounterResetSource_Counter4End,  //!< The selected counter can be reset by a Counter 4 End signal - Applies to: ace USB
        ...
        CounterResetSource_Encoder1,  //!< The selected counter can be reset by an Encoder 1 signal - Applies to: racer 2 CXP
        CounterResetSource_EncoderReverse1,  //!< The selected counter can be reset by an Encoder Reverse 1 signal - Applies to: racer 2 CXP
        ...
        CounterResetSource_FrequencyConverter,  //!< The selected counter can be reset by a Frequency Converter signal - Applies to: racer 2 CXP
        ...
        CounterResetSource_LineTriggerWait,  //!< The selected counter can be reset by a Line Trigger Wait signal - Applies to: racer 2 CXP
    ...
    enum CounterSelectorEnums
    {
        ...
        CounterSelector_Counter3,  //!< Counter 3 can be configured - Applies to: CameraLink, GigE and racer 2 CXP
        CounterSelector_Counter4  //!< Counter 4 can be configured - Applies to: CameraLink and GigE
    };
    ...
    enum CounterTriggerSourceEnums
    {
        ...
        CounterTriggerSource_Counter3Active,  //!< The selected counter can be started by a Counter 3 Active signal - Applies to: racer 2 CXP
        CounterTriggerSource_Counter3End,  //!< The selected counter can be started by a Counter 3 End signal - Applies to: racer 2 CXP
        CounterTriggerSource_Counter3Start,  //!< The selected counter can be started by a Counter 3 Start signal - Applies to: racer 2 CXP
        ...
        CounterTriggerSource_Encoder1,  //!< The selected counter can be started by an Encoder 1 signal - Applies to: racer 2 CXP
        CounterTriggerSource_EncoderReverse1,  //!< The selected counter can be started by an Encoder Reverse 1 signal - Applies to: racer 2 CXP
        ...
        CounterTriggerSource_FrequencyConverter,  //!< The selected counter can be started by a Frequency Converter signal - Applies to: racer 2 CXP
        ...
        CounterTriggerSource_LineTriggerWait,  //!< The selected counter can be started by a line Trigger Wait signal - Applies to: racer 2 CXP
    ...
    enum DeviceCharacterSetEnums
    {
        ...
        DeviceCharacterSet_UTF8  //!< The strings of the device's bootstrap registers use the UTF-8 character set - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
    };
    ...
    enum DeviceLinkThroughputLimitModeEnums
    {
        ...
        DeviceLinkThroughputLimitMode_On  //!< The Device Link Throughput Limit parameter is enabled - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB, dart USB and pulse USB
    };

    //! Valid values for DeviceRegistersEndianness
    enum DeviceRegistersEndiannessEnums
    {
        DeviceRegistersEndianness_Big,  //!< The endianness of the device's registers is big-endian - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        DeviceRegistersEndianness_Little  //!< The endianness of the device's registers is little-endian - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
    };

    //! Valid values for DeviceScanType
    enum DeviceScanTypeEnums
    {
        DeviceScanType_Areascan,  //!< The camera has an area scan sensor - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        DeviceScanType_Areascan3D,  //!< Device outputs 2D range image - Applies to: Stereo ace and blaze
        DeviceScanType_Linescan,  //!< The camera has a line scan sensor - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
    ...
    enum DeviceTLTypeEnums
    {
        ...
        DeviceTLType_CoaXPress,  //!< The device provides a CoaXPress transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        DeviceTLType_Custom,  //!< The device provides a custom transport layer - Applies to: Stereo ace and dart MIPI
        DeviceTLType_GigEVision,  //!< The device provides a GigE Vision transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        DeviceTLType_USB3Vision  //!< The device provides a USB3 Vision transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
    };
    ...
    {
        EncoderMode_FourPhase,  //!< The encoder mode is set to Four Phase - Applies to: racer 2 CXP
        EncoderMode_HighResolution  //!< The encoder mode is set to High Resolution - Applies to: racer 2 CXP
    };

    //! Valid values for EncoderOutputMode
    enum EncoderOutputModeEnums
    {
        EncoderOutputMode_DirectionDown,  //!< Output trigger signals are generated for all position increments in backward  direction of motion - Applies to: racer 2 CXP
        EncoderOutputMode_DirectionUp,  //!< Output trigger signals are generated for all position increments in forward direction of motion - Applies to: racer 2 CXP
        EncoderOutputMode_Motion,  //!< Output trigger signals are generated for motion increments in both forward and backward direction of motion - Applies to: racer 2 CXP
        EncoderOutputMode_Off,  //!< No output trigger signal is generated - Applies to: racer 2 CXP
        EncoderOutputMode_PositionDown,  //!< Output trigger signals are generated for all new position increments in backward direction of motion - Applies to: racer 2 CXP
        EncoderOutputMode_PositionUp  //!< Output trigger signals are generated for all new position increments in forward direction of motion - Applies to: racer 2 CXP
    };

    //! Valid values for EncoderSelector
    enum EncoderSelectorEnums
    {
        EncoderSelector_Encoder1  //!< Encoder 1 can be configured - Applies to: racer 2 CXP
    };

    //! Valid values for EncoderSourceA
    enum EncoderSourceAEnums
    {
        EncoderSourceA_Line1,  //!< The source signal for the A input of the encoder control is set to Line 1 - Applies to: racer 2 CXP
        EncoderSourceA_Line2,  //!< The source signal for the A input of the encoder control is set to Line 2 - Applies to: racer 2 CXP
        EncoderSourceA_Line3,  //!< The source signal for the A input of the encoder control is set to Line 3 - Applies to: racer 2 CXP
        EncoderSourceA_Off  //!< No source signal is set for the A input of the encoder control - Applies to: racer 2 CXP
    };

    //! Valid values for EncoderSourceB
    enum EncoderSourceBEnums
    {
        EncoderSourceB_Line1,  //!< The source signal for the B input of the encoder control is set to Line 1 - Applies to: racer 2 CXP
        EncoderSourceB_Line2,  //!< The source signal for the B input of the encoder control is set to Line 2 - Applies to: racer 2 CXP
        EncoderSourceB_Line3,  //!< The source signal for the B input of the encoder control is set to Line 3 - Applies to: racer 2 CXP
        EncoderSourceB_Off  //!< No source signal is set for the B input of the encoder control - Applies to: racer 2 CXP
    };
    ...
    enum ExposureModeEnums
    {
        ...
        ExposureMode_Timed,  //!< The exposure mode is set to Timed - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    ...
    {
        ExposureTimeMode_Common,  //!< The same exposure time is used for all components - Applies to: ace 2 GigE, ace 2 USB and boost CoaXPress
    ...
    {
        ExposureTimeSelector_Common,  //!< The Exposure Time parameter value applies to all components - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
    ...
    {
        FileOpenMode_Read,  //!< Files are opened in read-only mode - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        FileOpenMode_ReadWrite,  //!< This selects read and write open mode - Applies to: Stereo ace
        FileOpenMode_Write  //!< Files are opened in write-only mode - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    };

    //! Valid values for FileOperationSelector
    enum FileOperationSelectorEnums
    {
        FileOperationSelector_Close,  //!< The currently selected file can be closed - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        FileOperationSelector_Delete,  //!< Deletes the content of the file selected by FileSelector - Applies to: Stereo ace
        FileOperationSelector_Open,  //!< The currently selected file can be opened - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        FileOperationSelector_Read,  //!< The currently selected file can be read - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        FileOperationSelector_Write  //!< The currently selected file can be written to - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    };

    //! Valid values for FileOperationStatus
    enum FileOperationStatusEnums
    {
        FileOperationStatus_Failure,  //!< The file operation has failed - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        FileOperationStatus_Invalid,  //!< File content is invalid - Applies to: Stereo ace
        FileOperationStatus_Success  //!< The file operation was successful - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    };
    ...
    enum FileSelectorEnums
    {
        ...
        FileSelector_LineShadingDSNUCorrection,  //!< The file for Dark Signal Non-Uniformity (DSNU) correction is selected - Applies to: racer 2 CXP
        FileSelector_LineShadingPRNUCorrection,  //!< The file for Photo Response Non-Uniformity (PRNU) correction is selected - Applies to: racer 2 CXP
    ...
    {
        GainSelector_All,  //!< Changes to the gain will be applied universally - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB, pulse USB and racer 2 CXP
    ...
    {
        LUTSelector_Luminance  //!< The luminance lookup table can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
    };
    ...
    enum LineFormatEnums
    {
        ...
        LineFormat_RS422,  //!< The line is currently accepting or sending RS-422 level signals - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB and racer 2 CXP
    ...
    enum LineModeEnums
    {
        ...
        LineMode_Input,  //!< The selected physical line can be used to input an electrical signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        LineMode_Output  //!< The selected physical line can be used to output an electrical signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    };
    ...
    enum LineSourceEnums
    {
        ...
        LineSource_Counter3Active,  //!< The source signal for the currently selected line is set to Counter 3 Active - Applies to: racer 2 CXP
        LineSource_ExposureActive,  //!< The source signal for the currently selected line is set to Exposure Active - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        LineSource_LineTriggerWait,  //!< The source signal for the currently selected line is set to Line Trigger Wait - Applies to: CameraLink, GigE and racer 2 CXP
    ...
    enum PixelFormatEnums
    {
        ...
        PixelFormat_Mono8,  //!< The pixel format is set to Mono 8 - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        PixelFormat_RGB8,  //!< The pixel format is set to RGB 8 - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    {
        PtpServoStatus_Locked,  //!< The clock servo is locked - Applies to: Stereo ace and ace 2 GigE
        PtpServoStatus_Unknown  //!< The status of the clock servo is unknown - Applies to: Stereo ace and ace 2 GigE
    };

    //! Valid values for PtpStatus
    enum PtpStatusEnums
    {
        PtpStatus_Disabled,  //!< The port is in the Disabled state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Faulty,  //!< The port is in the Faulty state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Initializing,  //!< The port is in the Initializing state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Listening,  //!< The port is in the Listening state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Master,  //!< The port is in the Master state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Passive,  //!< The port is in the Passive state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_PreMaster,  //!< The port is in the PreMaster state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Slave,  //!< The port is in the Slave state - Applies to: Stereo ace, ace 2 GigE and blaze
        PtpStatus_Uncalibrated  //!< The port is in the Uncalibrated state - Applies to: Stereo ace, ace 2 GigE and blaze
    };
    ...
    {
        TimerTriggerActivation_AnyEdge,  //!< The timer will start at any edge signal change - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        TimerTriggerActivation_LevelHigh,  //!< The timer will start when the signal is high - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TimerTriggerActivation_LevelLow,  //!< The timer will start when the signal is low - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    ...
    enum TimerTriggerSourceEnums
    {
        ...
        TimerTriggerSource_Counter3Active,  //!< The selected timer can be started by a Counter 3 Active signal - Applies to: racer 2 CXP
        TimerTriggerSource_Counter3End,  //!< The selected timer can be started by a Counter 3 End signal - Applies to: racer 2 CXP
        TimerTriggerSource_Counter3Start,  //!< The selected timer can be started by a Counter 3 Start signal - Applies to: racer 2 CXP
        ...
        TimerTriggerSource_Encoder1,  //!< The selected timer can be started by an Encoder 1 signal - Applies to: racer 2 CXP
        TimerTriggerSource_EncoderReverse1,  //!< The selected timer can be started by an Encoder Reverse 1 signal - Applies to: racer 2 CXP
        ...
        TimerTriggerSource_FrequencyConverter,  //!< The selected timer can be started by a Frequency Converter signal - Applies to: racer 2 CXP
        ...
        TimerTriggerSource_LineTriggerWait,  //!< The selected timer can be started by a Line Trigger Wait signal - Applies to: racer 2 CXP
    ...
    {
        TriggerActivation_AnyEdge,  //!< The selected trigger is activated by the falling or rising edge of the source signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        TriggerActivation_FallingEdge,  //!< The selected trigger is activated by the falling edge of the source signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        TriggerActivation_RisingEdge  //!< The selected trigger is activated by the rising edge of the source signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    };
    ...
    {
        TriggerMode_Off,  //!< The currently selected trigger is turned off - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        TriggerMode_On  //!< The currently selected trigger is turned on - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    };
    ...
    enum TriggerSelectorEnums
    {
        ...
        TriggerSelector_FrameStart,  //!< The Frame Start trigger can be configured - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        TriggerSelector_LineStart  //!< The Line Start trigger can be configured - Applies to: CameraLink, GigE and racer 2 CXP
    };
    ...
    enum TriggerSourceEnums
    {
        ...
        TriggerSource_Counter1Active,  //!< The source signal for the selected trigger is set to Counter 1 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter1End,  //!< The source signal for the selected trigger is set to Counter 1 End - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter1Start,  //!< The source signal for the selected trigger is set to Counter 1 Start - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter2Active,  //!< The source signal for the selected trigger is set to Counter 2 Active - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter2End,  //!< The source signal for the selected trigger is set to Counter 2 End - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter2Start,  //!< The source signal for the selected trigger is set to Counter 2 Start - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        TriggerSource_Counter3Active,  //!< The source signal for the selected trigger is set to Counter 3 Active - Applies to: racer 2 CXP
        TriggerSource_Counter3End,  //!< The source signal for the selected trigger is set to Counter 3 End - Applies to: racer 2 CXP
        TriggerSource_Counter3Start,  //!< The source signal for the selected trigger is set to Counter 3 Start - Applies to: racer 2 CXP
        TriggerSource_CxpTrigger0,  //!< The source signal for the selected trigger is set to CXP Trigger 0 - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        TriggerSource_CxpTrigger1,  //!< The source signal for the selected trigger is set to CXP Trigger 1 - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        TriggerSource_Encoder1,  //!< The source signal for the selected trigger is set to Encoder 1 - Applies to: racer 2 CXP
        TriggerSource_EncoderReverse1,  //!< The source signal for the selected trigger is set to Encoder Reverse 1 - Applies to: racer 2 CXP
        TriggerSource_FrequencyConverter,  //!< The source signal for the selected trigger is set to Frequency Converter - Applies to: CameraLink, GigE and racer 2 CXP
        ...
        TriggerSource_Software,  //!< The source signal for the selected trigger is set to software triggering - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    ...
    {
        UserDefinedValueSelector_Value1,  //!< The user-defined value 1 can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        UserDefinedValueSelector_Value2,  //!< The user-defined value 2 can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        UserDefinedValueSelector_Value3,  //!< The user-defined value 3 can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        UserDefinedValueSelector_Value4,  //!< The user-defined value 4 can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        UserDefinedValueSelector_Value5  //!< The user-defined value 5 can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
    };
    ...
    */
    ...
    public:
        ...
        //@{
        /*!
            \brief Aborts the acquisition of images - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of frames to acquire for each Frame Burst Start trigger - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition line rate of the camera in kHz - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Enables setting the camera's acquisition line rate to a specified value - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the image acquisition mode - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Starts the acquisition of images - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the camera is waiting for trigger signals - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal whose status you want to check - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Stops the acquisition of images - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Controls how the AcquisitionStop command ends an ongoing frame - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Highlights the current auto function ROI in the image window - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function ROI from the left side of the sensor (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function ROI can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function ROI - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color channel can be adjusted when performing manual white balance - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Balance White Auto auto function - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent horizontal pixels to be summed - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for horizontal binning - Applies to: CamEmu, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sensor or FPGA binning can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Black level value to be applied to the currently selected sensor tap - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of black level adjustment to be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the burst mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether Acquisition Stop commands abort exposure - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Brightness value to be applied - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Centers the image horizontally - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which information should be included in the Chunk Timestamp Value chunk - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the timestamp when the image was acquired - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color adjustment - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Hue adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color in your images will be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color space for image acquisitions - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Contrast value to be applied - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the contrast mode - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Actual bandwidth the camera will use - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Current exposure time of the camera in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether an internal error occurred on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Retrieves the next error code from the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Error code indicating the cause of the internal error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure start delay with current settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will drive the frequency converter - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Multiplier value to increase the signal frequency - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Post-divider value to decrease the signal frequency - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Pre-divider value to decrease the signal frequency - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the frequency converter - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Hue shift value to be applied - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera evaluates all changes and durations of logical states of the input signal   - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera doesn't accept any further trigger signals or signal changes after receiving an input trigger signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables adjustment of the selected feature - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which features the camera adjusts when you select a light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether a GPIO line is overloaded, i e , not powered correctly - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Threshold value below which the device will set the Ptp Servo Status parameter to Locked, indicating that the device is sufficiently synchronized   - Applies to: ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of lines in kHz that can be acquired with current camera settings - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum number of frames that can be transferred per second with current camera settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation value to be applied - Applies to: GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the sensor acquisition mode - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the bit depth of the image sensor's data output - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the sensor bit depth mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power off - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Switches the sensor power on - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Puts the sensor in standby mode - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current power state of the sensor - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Absolute target value of the sensor brightness - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum brightness value detected by the camera during the creation of a PRNU shading correction set - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shading correction mode - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the shading correction type to be performed - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Creates a shading correction set - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the result of the shading correction set creation - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of the shading correction set created - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Index number of the shading correction set to be created - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the status of the shading correction set - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Relative target value of the sensor brightness you want to achieve - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the maximum temperature the camera reached during operation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the temperature state - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates how often the temperature state changed to Error - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which counter to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the selected chunk counter - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Includes the currently selected chunk in the payload data - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time used to acquire the image - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which exposure time to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the current frame - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Gain used during image acquisition - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which gain channel to retrieve chunk data from - Applies to: ace 2 GigE, ace 2 USB, ace USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief AOI height of the acquired image - Applies to: GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Bit field that indicates the status of all of the camera's input and output lines when the image was acquired - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the chunk mode - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief X offset of the AOI of the acquired image - Applies to: GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Y offset of the AOI of the acquired image - Applies to: GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief CRC checksum of the acquired image - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the pixel format of the acquired image - Applies to: GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which chunk can be enabled - Applies to: GigE, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the AOI of the acquired image - Applies to: GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color transformation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which type of color transformation will be performed - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Transformation value for the selected element in the color transformation matrix - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which element will be entered in the color transformation matrix - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Number of times a sequencer set is used before the Counter End event is generated - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that the counter will count - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which event increases the currently selected counter - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets the selected counter - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which type of signal transition will reset the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which source signal will reset the currently selected counter - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which counter can be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the current status of the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will start the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the signal used to start the selected counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Current value of the counter - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the CoaXPress physical connection to control - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of test packet connection errors received by the device on the connection selected by the Connection Selector parameter - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test mode for an individual physical connection of the device - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of test packets received by the device on the connection selected by the Cxp Connection Selector parameter - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the selected CoaXPress error counter - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which CoaXPress error counter to read or reset - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the current status of the selected CoaXPress error counter - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Current value of the selected CoaXPress error counter - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the link configuration - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the link configuration that allows the device to operate in its default mode - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the link configuration used by the device - Applies to: ace 2 CXP, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether the send or the receive features can be configured - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the character set used by the strings of the device's bootstrap registers - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Identifier of the product family of the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Disables feature streaming on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Enables feature streaming on the device - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera's firmware - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the behavior of the camera's status LED - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Speed of transmission negotiated on the selected link - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Bandwidth limit for data transmission (in bytes per second) - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables the device link throughput limit - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief First URL to the GenICam XML device description file of the selected manifest entry - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the schema file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the schema file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Additional information from the vendor about the camera - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera model - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Endianness of the registers of the device - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Announces the end of feature streaming - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Prepares the camera for feature streaming - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets and restarts the camera - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the SFNC specification that the camera is compatible with - Applies to: GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the scan type of the camera's sensor (area or line scan) - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Serial number of the camera - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the type of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the device's transport layer - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the tap geometry - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Temperature at the selected location in the camera (in degrees centigrade) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the location in the camera where the temperature will be measured - Applies to: CamEmu, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief User-settable ID of the camera - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera vendor - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Digital shift to be applied - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of encoder increments or decrements needed to generate an encoder output trigger signal - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the encoder mode - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the conditions for the encoder control to generate a valid output trigger signal - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the encoder control and restarts it - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which encoder can be configured - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the A input of the encoder control - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the B input of the encoder control - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Current value of the encoder control's position counter - Applies to: racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Frame ID of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Start event - Applies to: ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Frame Trigger Missed event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables event notifications for the currently selected event - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Event Overrun event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the event notification to be enabled - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief New temperature status that applies after the Temperature Status Changed event was raised - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the Temperature Status Changed event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Unique identifier of the Test event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Timestamp of the test event - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure mode - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure time mode - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB and boost CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which component the Exposure Time parameter value applies to - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Access buffer for file operations - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes read from the file into the file access buffer or written to the file from the file access buffer - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Number of bytes after which FileAccessLength bytes are read from the file into the file access buffer or are written to the file from the file access buffer - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the access mode in which a file is opened in the camera - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Executes the operation selected by File Operation Selector parameter - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief File operation result - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the target operation for the currently selected file - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the file operation execution status - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the target file in the camera - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain in dB - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the gain type to be adjusted - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Gamma correction to be applied - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Delay between the transmission of each packet on the selected stream channel - Applies to: CamEmu, GigE, Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Packet size in bytes on the selected stream channel  Excludes data leader and data trailer - Applies to: CamEmu, GigE, Stereo ace, ace 2 GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum height of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Stream ID of the first image stream - Applies to: ace 2 CXP, boost CoaXPress, boost V CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected lookup table (LUT) - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Pixel value to be replaced with the LUT Value pixel value - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the lookup table (LUT) to be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief New pixel value to replace the LUT Index pixel value - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief A single register that lets you access all LUT entries - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the electrical configuration of the currently selected line - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the signal inverter function for the currently selected input or output line - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the selected line - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line to be configured - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the currently selected line - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the current logical state of the selected line - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field indicating the current logical state of all available line signals at time of polling - Applies to: CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the region of interest (area of interest) from the left side of the sensor (in pixels) - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Size of the payload in bytes - Applies to: CamEmu, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Minimum possible pixel value that can be transferred from the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the format of the pixel data transmitted by the camera - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the depth of the pixel values in the image (in bits per pixel) - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current values from the device's PTP clock data set - Applies to: Stereo ace, ace 2 GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the Precision Time Protocol (PTP) - Applies to: Stereo ace, ace 2 GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched offset from the PTP master clock in nanoseconds - Applies to: Stereo ace, ace 2 GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched state of the clock servo - Applies to: Stereo ace and ace 2 GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Returns the latched state of the PTP clock - Applies to: Stereo ace, ace 2 GigE and blaze
        ...
        */
        ...
        //@{
        /*!
            \brief Enables horizontal mirroring of the image - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sensor readout time with current settings - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Executes the selected software signal - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the software signal to be executed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a Test event that can be used for testing event notification - Applies to: ace 2 GigE, ace 2 USB, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test pattern to display - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Delay of the currently selected timer in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Duration of the currently selected timer in microseconds - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Resets the selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the timer to be configured - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of the currently selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will start the timer - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Arm delay of the currently selected timer - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the internal camera signal used to trigger the selected timer - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Latches the current timestamp counter and stores its value in TimestampLatchValue - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, blaze, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Latched value of the timestamp counter - Applies to: Stereo ace, ace 2 GigE, ace 2 USB, ace USB, blaze, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will activate the selected trigger - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: CamEmu, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the currently selected trigger - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the trigger type to be configured - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a software trigger signal - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the selected trigger - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief User-defined value - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-defined value to set or read - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-settable output signal to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected user-settable output line - Applies to: CamEmu, CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Single bit field that sets the state of all user-settable output signals in one access - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to be used as the startup set - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the selected set into the camera's volatile memory and makes it the active configuration set - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Saves the current active set as the selected user set - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to load, save, or configure - Applies to: CameraLink, GigE, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum width of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost V CoaXPress, dart 2 USB, dart MIPI, dart USB, pulse USB and racer 2 CXP
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalCameraParams_Params : public CUniversalCameraParams_Params_v9_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalCameraParams_Params_v9_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalCameraParams
